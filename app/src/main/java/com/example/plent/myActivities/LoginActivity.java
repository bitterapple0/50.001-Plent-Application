...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (User u: userList){
            if (u.getEmail().toString() == email.getText().toString()) {
                ...
                if (u.getPassword() == password.getText().toString()) {
                    ...
                    Toast.makeText(this, "One or more of the entered credentials are incorrect. Please try again",
        ...
        if (emailInList == false) {
            Toast.makeText(this, "Looks like there is no account related to the entered email. \n" +
